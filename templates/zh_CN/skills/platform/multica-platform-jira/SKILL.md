...
| 调用方 | 实际调用 |
| --- | --- |
| `multica-pm-artifact-publish` | create-story / transition / … |
| `multica-artifact-architect` | get-confluence-url、append-artifact-link（发布由 confluence skill） |
| `multica-artifact-backend` / `-frontend` | append-artifact-link |
